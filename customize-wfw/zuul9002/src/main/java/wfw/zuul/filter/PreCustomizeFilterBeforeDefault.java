...
@Component
public class PreCustomizeFilterBeforeDefault extends ZuulFilter {

    private static Logger logger = LoggerFactory.getLogger(PreCustomizeFilterBeforeDefault.class);
